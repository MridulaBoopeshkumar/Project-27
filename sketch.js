...
/*bob1 = new Bob(100, 200, 30);
 bobDiameter = 40;
roof = new Roof(450, 200, 400, 10)
bob2 = new Bob(60, 200, 30);
bob3 = new Bob(20, 200, 30);
bob4 = new Bob(140, 200, 30);
bob5 = new Bob(180, 200, 30);*/
/*roof = new Roof(width/2, height/4, width/7, 20)
bobDiameter = 20;

startBobPositionX=width/2; 
startBobPositionY=height/4+500; 
bob1=new Bob(startBobPositionX-bobDiameter*1,startBobPositionY,bobDiameter);
